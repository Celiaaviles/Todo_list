      ...
      <section className="about">
        ...
        <div className="scroll-container">
          <p>
            Hi! My name is{" "}
            <a
              href="https://www.linkedin.com/in/celia-aviles/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Celia Avilés
            </a>{" "}
            and this is my small to-do list application. Hope you like it!
          </p>
          <p>
            In the following section, you can add a new task or modify it later
